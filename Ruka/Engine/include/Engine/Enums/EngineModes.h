 ...
 */
#define EN_ENUMS_ENGINE_MODE_INITIALIZATION                                     0

/**
 * @brief This mode is the scene mode, renders everything and updates
 * is it basically the playable game.
 */
#define EN_ENUMS_ENGINE_MODE_SCENE                                              1
